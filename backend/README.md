...
## Project Structure
    ...
    ├── time_helps_everyone_35626  # Django project configurations
...
1. Clone this repo and `cd time_helps_everyone_35626`
...
2. Clone this repo and `cd time_helps_everyone_35626`
